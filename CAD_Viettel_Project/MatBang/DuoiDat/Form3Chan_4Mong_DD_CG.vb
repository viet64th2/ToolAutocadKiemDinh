...
Public Class Form3Chan_4Mong_DD_CG
    Private Sub btnlai_Click_1(sender As Object, e As EventArgs) Handles btnlai.Click
        Dim acDoc As Document = Application.DocumentManager.MdiActiveDocument
        Dim acCurDb As Database = acDoc.Database
        Dim curUCSMatrix As Matrix3d = acDoc.Editor.CurrentUserCoordinateSystem
        Dim curUCS As CoordinateSystem3d = curUCSMatrix.CoordinateSystem3d
        ' 3 chân 4 móng loại 2
        ...
        mbVeMong.VeMong(x4, y4, b_bMong4, b_hMong4, b_a, b_bmove, b_hmove, "Móng 4", TextHight, Linetylescale, "1", "Dưới đất", b_Mong4)
        mbVeMong.Ve_Cot_Tam_Giac_update_4Mong(b_a, 0, 0, "5", "2", Linetylescale, Dimscale, TextHight, x1, y1, x2, y2, x3, y3, x4, y4, 4)
        mbVeMong.Ga_Chong_Xoay_MB_TamGiac(b_a, 0, 0, "0", "2", Linetylescale, Dimscale, TextHight, x1, y1, x2, y2, x3, y3, x4, y4, 4)
