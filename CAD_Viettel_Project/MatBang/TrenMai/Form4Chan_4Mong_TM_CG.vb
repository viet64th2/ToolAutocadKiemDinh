...
Public Class Form4Chan_4Mong_TM_CG
    Private Sub btn4chan4mong_Click(sender As Object, e As EventArgs) Handles btnlai.Click
        ...
        mbVeMong.VeMong(x1, y1, b_bMong1, b_hMong1, b_a, b_bmove, b_hmove, "Móng M1", TextHight, Linetylescale, "1", "Trên mái", b_Mong1)
        mbVeMong.VeMong(x2, y2, b_bMong2, b_hMong2, b_a, b_bmove, b_hmove, "Móng M2", TextHight, Linetylescale, "1", "Trên mái", b_Mong2)
        mbVeMong.VeMong(x3, y3, b_bMong3, b_hMong3, b_a, b_bmove, b_hmove, "Móng M3", TextHight, Linetylescale, "1", "Trên mái", b_Mong3)
        mbVeMong.VeMong(x4, y4, b_bMong4, b_hMong4, b_a, b_bmove, b_hmove, "Móng M4", TextHight, Linetylescale, "1", "Trên mái", b_Mong4)
