    ...
    Private Sub btnlai_Click(sender As Object, e As EventArgs) Handles btnlai.Click
        ...
        If cmbmat.Text = "X-Z" Then
            If ThongTinChung.SoChanCot <> 3 Then
                clsMatDung.MatY_Z_CoGa(c, b_a, KCM1, KCM2, listCaoDo, LoaiDot, b_zMong1, b_zMong2, b_bMong1, b_bMong2, b_z0mong, b_b0mong, ThongTinChung.LoaiMong1, z1, z1, ThongTinChung.ViTriDat, listViTriGaChongXay, frmTTC.dgvCaoDoDayCo.RowCount)
                clsMatDung.VeCaoDo(listCaoDo, 2, 3, z1, z1, KCM1, KCM2, b_hmong, b_hmong, 0, TiLeChu * 2)
                clsMatDung.VeCaoDoDot(KCM1, TiLeChu * 2)

            Else
                clsMatDung.MatY_Z_CoGa(c, b_a, KCM1, KCM2, listCaoDo, LoaiDot, b_zMong1, b_zMong2, b_bMong1, b_bMong2, b_z0mong, b_b0mong, ThongTinChung.LoaiMong1, z2, z3, ThongTinChung.ViTriDat, listViTriGaChongXay, frmTTC.dgvCaoDoDayCo.RowCount)
